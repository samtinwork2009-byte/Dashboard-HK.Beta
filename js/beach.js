...
const Beach = (function () {
	...
	const EPD_URL =
		"https://www.epd.gov.hk/epd/english/environmentinhk/water/beachwater/beach_bathing_e.html";
	...
	function renderBeaches() {
		...
		const filtered = BEACHES.filter((b) => {
			...
			if (
				...
				!b.en.toLowerCase().includes(search)
			)
				return false;
			return true;
		});
