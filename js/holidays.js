...
const Holidays = (function () {
	...
	const STATIC_HOLIDAYS = [
		{ date: "20240101", name: "一月一日" },
		{ date: "20240210", name: "農曆年初一" },
		{ date: "20240212", name: "農曆年初三" },
		{ date: "20240213", name: "農曆年初四" },
		{ date: "20240329", name: "耶穌受難節" },
		{ date: "20240330", name: "耶穌受難節翌日" },
		{ date: "20240401", name: "復活節星期一" },
		{ date: "20240404", name: "清明節" },
		{ date: "20240501", name: "勞動節" },
		{ date: "20240515", name: "佛誕" },
		{ date: "20240610", name: "端午節" },
		{ date: "20240701", name: "香港特別行政區成立紀念日" },
		{ date: "20240918", name: "中秋節翌日" },
		{ date: "20241001", name: "國慶日" },
		{ date: "20241011", name: "重陽節" },
		{ date: "20241225", name: "聖誕節" },
		{ date: "20241226", name: "聖誕節後第一個周日" },
		{ date: "20250101", name: "一月一日" },
		{ date: "20250129", name: "農曆年初一" },
		{ date: "20250130", name: "農曆年初二" },
		{ date: "20250131", name: "農曆年初三" },
		{ date: "20250404", name: "清明節" },
		{ date: "20250418", name: "耶穌受難節" },
		{ date: "20250419", name: "耶穌受難節翌日" },
		{ date: "20250421", name: "復活節星期一" },
		{ date: "20250501", name: "勞動節" },
		{ date: "20250505", name: "佛誕" },
		{ date: "20250531", name: "端午節" },
		{ date: "20250701", name: "香港特別行政區成立紀念日" },
		{ date: "20251001", name: "國慶日" },
		{ date: "20251007", name: "中秋節翌日" },
		{ date: "20251029", name: "重陽節" },
		{ date: "20251225", name: "聖誕節" },
		{ date: "20251226", name: "聖誕節後第一個周日" },
		{ date: "20260101", name: "一月一日" },
		{ date: "20260217", name: "農曆年初一" },
		{ date: "20260218", name: "農曆年初二" },
		{ date: "20260219", name: "農曆年初三" },
		{ date: "20260403", name: "耶穌受難節" },
		{ date: "20260404", name: "耶穌受難節翌日" },
		{ date: "20260406", name: "清明節翌日" },
		{ date: "20260407", name: "復活節星期一翌日" },
		{ date: "20260501", name: "勞動節" },
		{ date: "20260525", name: "佛誕翌日" },
		{ date: "20260619", name: "端午節" },
		{ date: "20260701", name: "香港特別行政區成立紀念日" },
		{ date: "20260926", name: "中秋節翌日" },
		{ date: "20261001", name: "國慶日" },
		{ date: "20261019", name: "重陽節翌日" },
		{ date: "20261225", name: "聖誕節" },
		{ date: "20261226", name: "聖誕節後第一個周日" },
	];
	...
	function renderUpcoming(holidays) {
		...
		const upcoming = holidays.filter((h) => daysUntil(h.date) >= 0).slice(0, 5);
	...
	function updateTabStyles(years) {
		years.forEach((y) => {
			...
			btn.style.background =
				y === _activeYear ? "var(--primary-lt)" : "var(--surface-2)";
			btn.style.color =
				y === _activeYear ? "var(--primary)" : "var(--text-muted)";
		});
	}
	...
	function showYear(year) {
		_activeYear = year;
		const years = [
			...new Set(_allHolidays.map((h) => h.date.getFullYear())),
		].sort();
	...
	function getAllSolarTerms() {
		return [...SOLAR_TERMS_2025, ...SOLAR_TERMS_2026].sort(
			(a, b) => a.date - b.date,
		);
	}
	...
	async function refresh() {
		...
		try {
			...
			console.warn(
				"[Holidays] Live API blocked (CORS), using static data:",
				e.message,
			);
		}
